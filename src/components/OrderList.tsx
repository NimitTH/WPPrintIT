...
const INITIAL_VISIBLE_COLUMNS = ["product", "screened_image", "price", "total_price", "quantity"];
            ...
            <div className="py-2 px-2 flex max-sm:flex-col justify-between items-center">
                ...
                <div>
                    <span className="mr-2 text-small font-medium text-default-400">
                        ...
                        ).format(orderItems.reduce((sum, item) => sum + item.product.price * item.quantity, 0))}</span>
                    </span>
                </div>
            </div>
        );
